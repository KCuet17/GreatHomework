...
import sample.Tower.AbstractTower;
...
public class Main extends Application {
    ...
    public void start(Stage theStage) {
        ...
        Button playButton= new Button(8*Config.SIZE,7*Config.SIZE,Config.SIZE*4,Config.playButton,gc);
        // sound
//        SoundTrack nhac= new SoundTrack();
//        nhac.getMediaPlayer().play();
...
*/
        ...
        new AnimationTimer()
        {
            ...
            public void handle(long currentNanoTime)
            {
                ...
                if(player1.getHealth()<=0){
                    ...
                    if(tick>=350*25 && enemies.size()<=0) theStage.setScene(win);
                    // Random enemy spawn
                    if(tick%350==0 && tick<=350*25){
        ...
        gc3.setFont(fontEnd );
        gc3.fillText(" YOU LOSE! ",Config.SIZE*5,Config.SIZE*4);
